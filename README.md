...
•	Dashboard Interaction - <a href="https://github.com/TrishalaDas23/UniHub-Store-Data-Analysis-using-MS-Excel/blob/main/2.%20Dashboard_Image.png">View Dashboard</a>

## Process
•	Verified data for any missing values and anomalies, and sort out the same.

•	Confirmed data is consistent and clean with respect to data type, data format and values used.
